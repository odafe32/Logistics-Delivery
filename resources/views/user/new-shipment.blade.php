                ...
                <div class="form-container">
                    ...
                    <div class="form-section">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <!-- Express Delivery -->
                            <div class="service-option" onclick="document.getElementById('expressService').checked = true">
                                <input type="radio" name="service_type" value="express" id="expressService" class="hidden" checked>
                                <div class="p-6 rounded-xl border-2 border-transparent hover:border-gray-200 cursor-pointer">
                                    ...
                                    <p class="text-sm text-gray-600 mb-4">1-2 business days</p>
                                    <div class="price-tag text-xl font-bold">$25.99</div>
                                </div>
                            </div>

                            <!-- Standard Delivery -->
                            <div class="service-option" onclick="document.getElementById('standardService').checked = true">
                                <input type="radio" name="service_type" value="standard" id="standardService" class="hidden">
                                <div class="p-6 rounded-xl border-2 border-transparent hover:border-gray-200 cursor-pointer">
                                    <div class="flex items-center justify-between mb-4">
                                    ...
                                    <h3 class="text-lg font-semibold mb-2">Standard Delivery</h3>
                                    <p class="text-sm text-gray-600 mb-4">3-5 business days</p>
                                    <div class="price-tag text-xl font-bold">$15.99</div>
                                </div>
                            </div>

                            <!-- Economy Delivery -->
                            <div class="service-option" onclick="document.getElementById('economyService').checked = true">
                                <input type="radio" name="service_type" value="economy" id="economyService" class="hidden">
                                <div class="p-6 rounded-xl border-2 border-transparent hover:border-gray-200 cursor-pointer">
                                    <div class="flex items-center justify-between mb-4">
                                    ...
                                    <h3 class="text-lg font-semibold mb-2">Economy Delivery</h3>
                                    <p class="text-sm text-gray-600 mb-4">5-7 business days</p>
                                    <div class="price-tag text-xl font-bold">$10.99</div>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        if (e.target.closest('.remove-package')) {
                    ...
                    if (data.success) {
                        ...
                        await Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                window.location.href = '/shipment-history';
                            }
                        });
                    } else {
            ...
            saveAsDraftBtn.addEventListener('click', async function() {
                ...
                try {
                    ...
                    const response = await fetch('/shipments/draft', {
                        method: 'POST',
                        body: formData,
                        headers: {
                            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content
