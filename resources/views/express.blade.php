    ...
    <section class="breadcrumb py-140 tw-pt-206-px mb-0 bg-img"
        ...
        <div class="container">
            <div class="text-center">
                ...
                <h1 class="splitTextStyleOne text-white tw-mt-1 cursor-big">Express Services</h1>
            </div>
        </div>
    </section>
    ...
    <section class="service-details py-140">
        <div class="container">
            <div class="row gy-4">
                ...
                <div class="col-xl-8">
                    <div class="">
                        <img src="assets/images/thumbs/service-details-img.png" alt="Express Services">
                        <div class="tw-mt-8 d-flex flex-column tw-gap-12">
                            <div class="">
                                <h4 class="tw-mb-3 cursor-big splitTextStyleOne">Express Delivery Solutions</h4>
                                <p class="text-neutral-1000 cursor-small">Our express delivery services provide fast,
                                    ...
                                    packages.
                                    Our express network ensures quick and secure delivery across domestic and international
                                    routes.</p>
                            </div>
                            <div class="">
                                ...
                                <p class="text-neutral-1000 cursor-small">We specialize in time-critical deliveries with
                                    options for same-day, next-day, and scheduled delivery services. Our express solutions
                            ...
                            <div class="d-flex tw-gap-9">
                                <div class="position-relative max-w-390-px w-100">
                                    <img src="assets/images/thumbs/service-details-video-img.jpg" alt="Express Services">
                                ...
                                <div class="">
                                    <h4 class="tw-mb-3 cursor-big splitTextStyleOne">Why Choose Our Express Services?</h4>
                                    <p class="text-neutral-1000 cursor-small">Experience unmatched speed and reliability
                                        with our express delivery solutions.</p>
                            ...
                            <p class="text-neutral-1000 cursor-small">Our express delivery network is designed for
                                speed and efficiency. We offer flexible pickup options, late cutoff times, and early
                                delivery services. Our dedicated express team ensures your time-sensitive shipments
                            ...
                            <p
                                ...
                                When time is critical, trust our express services to deliver your packages quickly and
                                securely,
                                maintaining the highest standards of reliability and care.
                            </p>

                            <div class="">
                                <h5 class="tw-mb-8 cursor-big">Our Express Services Include:</h5>
