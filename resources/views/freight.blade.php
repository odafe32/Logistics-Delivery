    ...
    <section class="breadcrumb py-140 tw-pt-206-px mb-0 bg-img"
        ...
        <div class="container">
            <div class="text-center">
                ...
                <h1 class="splitTextStyleOne text-white tw-mt-1 cursor-big">Freight Services</h1>
            </div>
        </div>
    </section>
    <!-- Breadcrumb End Here -->
    ...
    <section class="service-details py-140">
        <div class="container">
            <div class="row gy-4">
                ...
                <div class="col-xl-8">
                    <div class="">
                        <img src="assets/images/thumbs/service-details-img.png" alt="Freight Services">
                        <div class="tw-mt-8 d-flex flex-column tw-gap-12">
                            <div class="">
                                <h4 class="tw-mb-3 cursor-big splitTextStyleOne">International Freight Transportation</h4>
                                <p class="text-neutral-1000 cursor-small">Our comprehensive freight services offer seamless
                                    transportation solutions across air, sea, and land. We specialize in handling diverse
                                    cargo
                                    types, from standard shipments to specialized freight, ensuring your goods reach their
                                    destination safely and on time. With our global network and experienced team, we provide
                                    efficient, cost-effective freight solutions tailored to your business needs.</p>
                            </div>
                            <div class="">
                                <h5 class="tw-mb-3 cursor-big splitTextStyleOne">Comprehensive Freight Solutions</h5>
                                <p class="text-neutral-1000 cursor-small">We offer end-to-end freight management services,
                                    ...
                                    partnerships
                                    to optimize routes and reduce transit times, ensuring reliable and efficient freight
                                    delivery worldwide.</p>
                            </div>
                            <div class="d-flex tw-gap-9">
                                <div class="position-relative max-w-390-px w-100">
                                    <img src="assets/images/thumbs/service-details-video-img.jpg" alt="Freight Services">
                                ...
                                <div class="">
                                    <h4 class="tw-mb-3 cursor-big splitTextStyleOne">Why Choose Our Freight Services?</h4>
                                    <p class="text-neutral-1000 cursor-small">We prioritize reliability, efficiency, and
                                        customer satisfaction in every freight operation.</p>
                            ...
                            <p class="text-neutral-1000 cursor-small">Our freight services encompass a wide range of
                                ...
                                dedicated team coordinates every aspect of the freight journey, providing seamless
                            ...
                            <p
                                ...
                                We deliver excellence in freight services, combining global reach with local expertise to
                                ensure your cargo reaches its destination safely and efficiently.
                            </p>

                            <div class="">
                                <h5 class="tw-mb-8 cursor-big">Our Freight Services Include:</h5>
                                    ...
                                    <div class="accordion-item tw-p-205 tw-rounded-lg bg-white border border-neutral-200"
                                        ...
                                        <h2 class="accordion-header">
                                            <button
                                                ...
                                                How do you handle international freight shipments?
                                            </button>
                                        </h2>
